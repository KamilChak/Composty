"""
Django settings for CompostMarket project.
...
SECRET_KEY = 'django-insecure-$a*#pj&t#^6&&s$9p2-yh-7#j0+9mq8+*a9f++toanul*=&=0)'
...
MIDDLEWARE = [
    ...
    'CompostMarket.middleware.AutoRedirectMiddleware',
]

ROOT_URLCONF = 'CompostMarket.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['CompostMarket/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
os.environ['GDAL_LIBRARY_PATH'] = 'C:/OSGeo4W64/bin/gdal300.dll'
